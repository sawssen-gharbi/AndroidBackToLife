...
class ajoutEvent : Fragment() {
   // lateinit var mDatePickerBtn : Button
    ...
    lateinit var dispo : TextInputLayout

    lateinit var butLoc:Button
    ...
    private fun doAjout() {
        if (isValide1()){
           ...
           // val reqFile = f.asRequestBody("image/jpeg".toMediaTypeOrNull())
            ...
            map["address"]=address1.toString()!!.toRequestBody("multipart/form-data".toMediaTypeOrNull())
            map["dispo"] = dispo.editText?.text.toString().toRequestBody("multipart/form-data".toMediaTypeOrNull())
                    ...
                    Response<TherapyResponse>
                        ...
                        if (therapy != null) {
                            mSharedPref.edit().apply {
                                ...
                                putBoolean(DISPO,therapy.therapy.dispo)

                                putString(ADRESS,address1.toString())
